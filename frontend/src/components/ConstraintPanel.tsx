    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5 flex flex-col gap-4 text-zinc-100">
      ...
      <div className="grid grid-cols-2 gap-3 font-mono text-xs">
        <div className="p-3 bg-zinc-950/60 border border-zinc-800 rounded-lg flex flex-col gap-1">
          ...
          <span className="font-bold text-zinc-200">{minTraceWidthMm} mm</span>
        </div>
        <div className="p-3 bg-zinc-950/60 border border-zinc-800 rounded-lg flex flex-col gap-1">
          <span className="text-zinc-500">Min Clearance</span>
          <span className="font-bold text-zinc-200">{minClearanceMm} mm</span>
        </div>
        <div className="p-3 bg-zinc-950/60 border border-zinc-800 rounded-lg flex flex-col gap-1">
          <span className="text-zinc-500">Max Component Temp</span>
          <span className="font-bold text-rose-400">{maxBoardTempC} °C</span>
        </div>
        <div className="p-3 bg-zinc-950/60 border border-zinc-800 rounded-lg flex flex-col gap-1">
          <span className="text-zinc-500">Diff Impedance (USB)</span>
          <span className="font-bold text-indigo-300">{targetDiffImpedanceOhm} Ω ± 10%</span>
        </div>
      </div>
    </div>
  );
